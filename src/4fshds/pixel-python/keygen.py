...
def key_test_vector_gen():
    ...
    f = open("../test_vector/test_vector/pk_bin.txt", "wb")
    f.write(pk_buf)
    f.close()

    sk_buf = serialize_sk(sk)
    f = open("../test_vector/test_vector/sk_bin_01.txt", "wb")
    f.write(sk_buf)
    f.close()
...
def setup_pixel():
    ...
    t = end - start
    return pk, msk, prng, t

def keygen_pixel(pk, msk, prng):
    start = time.time()
...
if __name__ == "__main__":
    def main():
        key_test_vector_gen()
        assert filecmp.cmp("../test_vector/test_vector/pk_bin.txt", "../test_vector/test_vector/pk_bin.txt")
        assert filecmp.cmp("../test_vector/test_vector/sk_bin_01.txt", "../test_vector/test_vector/sk_bin_01.txt")
    main()
