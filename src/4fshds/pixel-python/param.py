...
# write to the output
f = open("../test_vector/test_vector/param_bin.txt", "wb")
f.write(buf)
f.close()
...
if __name__ == "__main__":
    def main():
        shutil.copy2("../test_vector/test_vector/param_bin.txt", "../test_vector/test_vector/param_bin.txt")
        assert filecmp.cmp("../test_vector/test_vector/param_bin.txt", "../test_vector/test_vector/param_bin.txt")
    main()
